                ...
                <div class="row m-5">
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('mobil/simpan_kapasitas'); ?>" method="post" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="jumlah_kapasitas" name="jumlah_kapasitas" placeholder="Masukkan Kapasitas Mobil">
                                        <?= form_error(
                                            'jumlah_kapasitas',
