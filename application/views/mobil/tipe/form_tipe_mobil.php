                    ...
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('mobil/simpan_tipe'); ?>" method="post" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="nama_tipe" name="nama_tipe" placeholder="Masukkan Tipe Mobil">
                                        <?= form_error(
                                            'nama_tipe',
