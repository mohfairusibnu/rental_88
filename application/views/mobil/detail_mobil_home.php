                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <td>
                                    <a href="<?= base_url('autentifikasi_cust') ?>" class="btn  btn-dark float-right"><i class="fa fa-reply"></i> Sewa</a>
                                    <a href="<?= base_url('dashboard_home') ?>" class="btn  btn-default float-right"><i class="fa fa-reply"></i> Kembali</a>
                                </td>
                            </div>
                        </div>
                    </div>
