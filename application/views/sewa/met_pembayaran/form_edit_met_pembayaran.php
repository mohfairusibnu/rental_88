                ...
                <div class="row m-5">
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('sewa/update_met_pembayaran'); ?>" method="post" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <input type="hidden" name="id_mp" id="id_mp" value="<?= $mp->id_mp ?>">
                                        <input type="text" class="form-control" id="nama_mp" name="nama_mp" value="<?= $mp->nama_mp ?>" placeholder="Masukkan Metode Pembayaran">
                                        <?= form_error(
                                            'nama_mp',
